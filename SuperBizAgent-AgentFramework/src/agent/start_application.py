...
def check_dependencies():
    ...
    dependencies = {
        "agentic_rag_final": False,
        "kb_manager_advanced": False,
        "ai_chat_system": False,
        "unified_link_document_processor": False,
        "multimodal_gui": False,
        "rag_manager_gui_optimized": False,
    }
...
def main():
    ...
    # 创建主窗口
    root = tk.Tk()
    root.title("SuperBizAgent - AI 文档处理与知识库系统")
    ...
    def open_kb_manager():
        try:
            from rag_manager_gui_optimized import RAGManagerGUIOptimized
    ...
    def open_unified():
        try:
            from unified_link_document_gui import UnifiedLinkDocumentGUI
    ...
    status_label = tk.Label(
        status_frame,
        text="就绪 | 主模型: Doubao-Seed-2.0-Code | 备用模型: Doubao-Seed-2.0-mini",
        font=("微软雅黑", 9),
        bg="#e5e7eb",
        fg="#374151"
    )
